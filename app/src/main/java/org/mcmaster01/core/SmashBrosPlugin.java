...
import org.mcmaster01.listeners.PlayerQuitListener;
...
public void onEnable() {
    ...
    //create a scheduled repeating task to update scoreboard of players
    Bukkit.getScheduler().scheduleSyncRepeatingTask(this, new PlayerScoreboardUpdater(this), 0, 20);
